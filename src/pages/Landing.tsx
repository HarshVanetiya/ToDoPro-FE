...
import { CheckSquare, Zap, Shield, BarChart3, Users, Star, ArrowRight, Check } from 'lucide-react'
...
const features = [
  {
    ...
    description: 'Organize your tasks with priorities, due dates, and categories for maximum productivity.'
  },
  {
    icon: BarChart3,
  ...
  },
  {
    ...
    description: 'Built with modern technology for instant responses and smooth interactions.'
  },
  {
    icon: Shield,
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-primary block">Beautiful Simplicity</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              ToDoPro is the most elegant way to manage your tasks, track your progress, 
              and achieve your goals. Built for professionals who demand excellence.
            </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join thousands of users who have already made the switch to ToDoPro.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-lg font-bold">ToDoPro</span>
              </div>
              <p className="text-gray-400">
                Beautiful task management for modern professionals.
              </p>
            </div>
